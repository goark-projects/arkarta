...
func Upgrade(
	ctx context.Context,
	req *arkservlet.Request,
	res arkservlet.Response,
	handler Handler,
	options ...websocket.HandshakeOption,
...
func (a *Adapter) Upgrade(
	...
	err = upgrade.HTTP(
		...
		req,
		res,
		upgrade.HandlerFunc(func(ctx context.Context, conn upgrade.Connection) error {
