...
func validateGT(_ context.Context, field FieldContext) (Violation, bool, error) {
	return validateComparison(
		field,
		"gt",
		"数值必须大于 "+field.Rule().Param(),
		func(value, limit float64) bool {
			return value > limit
		},
	)
}
...
func validateComparison(
	field FieldContext,
	code, message string,
	pass func(value, limit float64) bool,
